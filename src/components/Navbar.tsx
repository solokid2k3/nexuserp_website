    ...
    <nav className={`navbar ${scrolled ? 'navbar--scrolled' : ''}`}>
      <div className="navbar__inner container-wide">
        ...
        <div className={`navbar__links ${mobileOpen ? 'navbar__links--open' : ''}`}>
          {links.map(l => (
            <a key={l.href} href={l.href} className="navbar__link" onClick={() => setMobileOpen(false)}>{l.label}</a>
          ))}
          <a href="https://github.com" target="_blank" rel="noopener" className="navbar__cta">
